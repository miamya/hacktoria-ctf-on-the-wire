...
## Second Approach
Since the attempt with HTTP traffic resulted in nothing, let's try a different approach. The hint says to find a message that **leads** to the contract card, my best guess that it should be a URL that **leads** our objective. 
